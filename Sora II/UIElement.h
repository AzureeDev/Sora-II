...
namespace Lilac::UI
{
	...
	public:
		virtual void set_position(const Vector2i pos); // Set the X Y position
		virtual void set_x(const int x); // Set only the X coordinates
		virtual void set_y(const int y); // Set only the Y coordinates
